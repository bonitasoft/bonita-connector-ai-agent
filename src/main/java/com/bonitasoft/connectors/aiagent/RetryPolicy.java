 ...
 * Config: maxRetries, initial wait 1s, max 64s.
...
public class RetryPolicy {
     ...
     */
    public <T> T execute(Callable<T> action) throws AiAgentException {
        int attempt = 0;
        while (true) {
            try {
                return action.call();
                ...
                throw new AiAgentException("Unexpected error during API call", e);
            }
        }
    }
